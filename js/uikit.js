...
(function(global, factory) {
    ...
    */
    ...
    function componentAPI(UIkit) {
        ...
        UIkit.component = function(id, options) {
            ...
            UIkit[name] = function(element, data) {
                ...
                return $$1__default(element).toArray().map(function(element) { return UIkit.getComponent(element, name) || new UIkit.components[name]({ el: element, data: data || {} }); })[0];
            };
    ...
    var Toggable = {
        ...
        methods: {
            ...
            toggleElement: function toggleElement(targets, show, animate) {
                ...
                var queued = this.queued && this.hasAnimation,
                    toggles, body = document.body,
    ...
    var Modal = {
        ...
        methods: {
            ...
            _toggleImmediate: function _toggleImmediate(el, show) {
                ...
                return this.transitionDuration ? promise(function(resolve) {
                    this$1.panel.one(transitionend, resolve);
                    setTimeout(function() {
                        resolve();
                        this$1.panel.off(transitionend, resolve);
                    }, this$1.transitionDuration);
                }) : promise.resolve();
            },
        }
        ...
        UIkit.component('cover', {
            ...
            update: {
                ...
                write: function write() {
                    ...
                    this.$el
                        .css({ width: '', height: '' })
                        .css(Dimensions.cover({ width: this.width || this.el.clientWidth, height: this.height || this.el.clientHeight }, { width: this.parent.offsetWidth, height: this.parent.offsetHeight }));
    ...
    function Navbar(UIkit) {
        ...
        UIkit.component('navbar', {
            ...
            ready: function ready() {
                ...
                if (this.dropbar) {
                    UIkit.navbarDropbar(
                        query(this.dropbar, this.$el) || $$1__default('<div></div>').insertAfter(this.dropbarAnchor || this.$el), { clsDrop: this.clsDrop, mode: this.dropbarMode, duration: this.duration, navbar: this }
                    );
                }
    ...
    function Offcanvas(UIkit) {
        ...
        UIkit.component('offcanvas', {
            ...
            computed: {
                ...
                clsPageOverlay: function clsPageOverlay() {
                ...
                clsPageAnimation: function clsPageAnimation() {
    ...
    function core(UIkit) {
        ...
        var scroll = null,
            dir, ticking, resizing, started = 0;
    ...
    function plugin$1(UIkit) {
        ...
        UIkit.component('notification', {
            ...
            ready: function ready() {
                ...
                Transition.start(
                    this.$el.css({ opacity: 0, marginTop: -1 * this.$el.outerHeight(), marginBottom: 0 }), { opacity: 1, marginTop: 0, marginBottom: marginBottom }
                ).then(function() {
                    if (this$1.timeout) {
        ...
        UIkit.component('sortable', {
            ...
            methods: {
                ...
                init: function init(e) {
                    ...
                    var target = $(e.target),
                        placeholder = this.$el.children().filter(function(i, el) { return isWithin(e.target, el); });
